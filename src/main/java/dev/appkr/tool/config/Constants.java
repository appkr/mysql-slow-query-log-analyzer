package dev.appkr.tool.config;

import java.time.ZoneId;

public class Constants {

  public static final String PROJECT_NAME = "myql-slow-query-log-analyzer";
  public static final String SYSTEM_ACCOUNT = "system";
  public static final String UNKNOWN_USER_ID = "00000000-0000-0000-0000-000000000000";
  public static final String V1_MEDIA_TYPE = "application/json";
  ...
  public static class LogKey {
    public static final String HTTP_INBOUND_LOGGER = "dev.appkr.tool.http.api";
    public static final String HTTP_OUTBOUND_LOGGER = "dev.appkr.tool.http.external";
