package dev.appkr.tool.adapter.in.rest.exception;

import static dev.appkr.tool.config.Constants.PROJECT_NAME;
import static org.springframework.http.HttpStatus.BAD_REQUEST;

import dev.appkr.tool.application.port.in.exception.ConstraintViolationProblem;
import dev.appkr.tool.domain.FieldError;
